...
namespace _qt_qml_CarScreenUI_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appCarScreenUI)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appCarScreenUI))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appCarScreenUI)() {
    return 1;
}
